...
public class CookieController implements SubController {
    ...
    public CookieController(SuccessGenerator successGenerator) {
    ...
    public byte[] generate(Request request, LinkedHashMap<String, LinkedHashMap<String, String>> routes) {
        ...
        if (thereAreCookiesToBeSet(request, routes)) { return successGenerator.generateSetCookie(SuccessGenerator.Code.OK); }
        return successGenerator.generateGetCookie(SuccessGenerator.Code.OK, uri);
    }
}
